...
export const calculatePipeIntersections = (
    pipe1: [number, number][],
    pipe2: [number, number][]
): boolean => {
...
export const calculateMainPipeIntersections = (
    mainPipe: [number, number][],
    submainPipes: Array<{ coordinates: [number, number][] }>
): number => {
...
export const calculateSubmainPipeIntersections = (
    submainPipe: [number, number][],
    branchPipes: Array<{ start: { lat: number; lng: number }; end: { lat: number; lng: number } }>
): number => {
    let intersectionCount = 0;
