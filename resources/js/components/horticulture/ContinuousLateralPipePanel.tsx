                    ...
                    <div className="p-3 space-y-3">
                        ...
                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                            ...
                            <div className="text-xs text-yellow-700 space-y-1">
                                <div>• {t('คลิกในแผนที่เพื่อเริ่มวาดท่อใหม่') || 'คลิกในแผนที่เพื่อเริ่มวาดท่อใหม่'}</div>
                                <div>• {t('เมื่อวาดเสร็จจะสามารถวาดท่อต่อไปได้ทันที') || 'เมื่อวาดเสร็จจะสามารถวาดท่อต่อไปได้ทันที'}</div>
                                <div>• {t('เปลี่ยนรูปแบบการวางได้ตลอดเวลา') || 'เปลี่ยนรูปแบบการวางได้ตลอดเวลา'}</div>
                                <div>• {t('กดหยุดการวาดเมื่อต้องการจบ') || 'กดหยุดการวาดเมื่อต้องการจบ'}</div>
                            </div>
                        </div>
                    </div>
