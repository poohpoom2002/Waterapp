    ...
    const handleRefreshTokens = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                // Update the token status with the new data
                ...
                <div className="relative z-[10000] max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-gray-900 p-8">
                    <div className="mb-6 flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-400">Current balance: {tokenStatus?.current_tokens || 0} tokens</p>
                        </div>
                        <button
                    ...
                    <div className="mb-8 rounded-lg border border-gray-700 bg-gray-800 p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <h3 className="text-xl font-semibold text-white">Your Token Balance</h3>
                                <p className="text-gray-400">Use tokens to access premium features</p>
                            </div>
                            <div className="text-right">
                                <div className="text-3xl font-bold text-blue-400">
                                    {tokenStatus?.current_tokens || 0}
                                </div>
                    ...
                    <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
                        ...
                        <div className="space-y-3 text-gray-300">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <strong>Daily Refresh:</strong> Get 50 free tokens every 24 hours
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                    ...
                    {tokenStatus && (
                        <div className="mt-6 rounded-lg border border-gray-700 bg-gray-800 p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <div className="text-2xl font-bold text-green-400">{tokenStatus.refresh_count || 0}</div>
