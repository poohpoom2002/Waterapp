            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="mb-8 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-gray-400">
                            Manage your irrigation fields and pipe networks
                        </p>
                    </div>
                    <button
                ...
                {fields.length === 0 ? (
                    <div className="py-16 text-center">
                        ...
                        <h2 className="mb-2 text-2xl font-semibold text-white">No Fields Yet</h2>
                        <p className="mb-6 text-gray-400">
                            Start by creating your first irrigation field
                        </p>
                        <button
                            onClick={handleAddField}
                    ...
                    <div className="mx-4 w-full max-w-md rounded-lg bg-gray-800 p-6">
                        ...
                        <div className="mb-6">
                            ...
                            <p className="mt-2 text-sm text-gray-400">
                                This action cannot be undone. All field data, planting points,
                                pipes, and zones will be permanently deleted.
                            </p>
                        </div>
