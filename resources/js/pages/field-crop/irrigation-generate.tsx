...
export default function IrrigationGenerate({
    ...
    console.log('Final obstacles for rendering:', {
        ...
        finalObstacles: finalObstacles.map((o) => ({
            type: o.type,
            coordinates: o.coordinates.length,
        })),
    });
    ...
    const calculateTotalWaterRequirement = () => {
        ...
        console.log(
            `Primary crop: ${primaryCrop}, Water per plant: ${waterPerPlant} ลิตร/ครั้ง/plant`
        );
    ...
    const handleBack = () => {
        ...
        try {
            localStorage.setItem('fieldCropData', JSON.stringify(allData));
        } catch {
            /* ignore storage errors */
        }

        console.log(
            'Going back to initial-area - preserving all data including irrigation in localStorage'
        );
    ...
    const generateSprinklerSystem = useCallback(async () => {
        ...
        console.log(
            'Generating sprinkler system using center-first approach - radius:',
        ...
        try {
            ...
            console.log(
                `Sprinkler generation: center Y=${centerY.toFixed(2)}, rows above=${rowsAboveCenter}, rows below=${rowsBelowCenter}`
            );
            ...
            console.log(
                `Sprinkler generation: center X=${centerX.toFixed(2)}, cols left=${colsLeftOfCenter}, cols right=${colsRightOfCenter}`
            );
                ...
                for (let colIndex = 0; colIndex < allColXs.length; colIndex++) {
                    ...
                    if (insideMain && !insideAnyHole) {
                        ...
                        if (distanceFromEdge >= bufferDistance) {
                            ...
                            console.log(
                                `Placed sprinkler at row ${rowIndex}, col ${colIndex}:`,
                                latLng
                            );
                        } else {
                            console.log(
                                `Skipped sprinkler at row ${rowIndex}, col ${colIndex} - too close to edge (${distanceFromEdge.toFixed(1)}m < ${bufferDistance}m)`
                            );
                        }
                    } else if (insideAnyHole) {
                        console.log(
                            `Skipped sprinkler at row ${rowIndex}, col ${colIndex} - inside obstacle`
                        );
                    }
                }
            }
            ...
            console.log(
                `Total sprinklers generated: ${sprinklers.length} using center-first approach`
            );
    ...
    const generatePivotSystem = useCallback(async () => {
        ...
        setIsGeneratingIrrigation(true);
        console.log(
            'Generating pivot system using center-first approach - radius:',
        ...
        try {
            ...
            console.log(
                `Pivot generation: center Y=${centerY.toFixed(2)}, rows above=${rowsAboveCenter}, rows below=${rowsBelowCenter}`
            );
            ...
            console.log(
                `Pivot generation: center X=${centerX.toFixed(2)}, cols left=${colsLeftOfCenter}, cols right=${colsRightOfCenter}`
            );
                ...
                for (let colIndex = 0; colIndex < allColXs.length; colIndex++) {
                    ...
                    if (insideMain && !insideAnyHole) {
                        ...
                        if (distanceFromEdge >= bufferDistance) {
                            ...
                            pivots.push(latLng);
                            console.log(
                                `Placed pivot at row ${rowIndex}, col ${colIndex}:`,
                                latLng
                            );
                        } else {
                            console.log(
                                `Skipped pivot at row ${rowIndex}, col ${colIndex} - too close to edge (${distanceFromEdge.toFixed(1)}m < ${bufferDistance}m)`
                            );
                        }
                    } else if (insideAnyHole) {
                        console.log(
                            `Skipped pivot at row ${rowIndex}, col ${colIndex} - inside obstacle`
                        );
                    }
                }
            }
    ...
    const generateDripTape = useCallback(async () => {
        ...
        setIsGeneratingIrrigation(true);
        console.log(
            'Generating drip tape with center-first approach - spacing:',
            irrigationSettings.drip_tape.emitterSpacing,
            'placement:',
            irrigationSettings.drip_tape.placement,
            'side:',
        ...
        try {
            ...
            console.log(
                `Reordered ${reorderedRows.length} rows starting from center row ${centerIndex}`
            );
            ...
            reorderedRows.forEach((row, rowIndex) => {
                ...
                for (let i = 0; i < row.length; i++) {
                    ...
                    if (
                        ...
                        console.log(`Skipped drip tape at row ${rowIndex} - inside obstacle:`, {
                            lat: dripLat,
                            lng: dripLng,
                        });
                    }
            ...
            console.log(
                'Generated',
                dripPositions.length,
                'drip tape positions using center-first approach'
            );
    ...
    const generateWaterJetTape = useCallback(async () => {
        ...
        setIsGeneratingIrrigation(true);
        console.log(
            'Generating water jet tape with center-first approach - spacing:',
        ...
        try {
            ...
            reorderedRows.forEach((row, rowIndex) => {
                ...
                for (let i = 0; i < row.length; i++) {
                    ...
                    if (
                        ...
                        console.log(`Skipped water jet at row ${rowIndex} - inside obstacle:`, {
                            lat: jetLat,
                            lng: jetLng,
                        });
                    }
            ...
            console.log(
                'Generated',
                jetPositions.length,
                'water jet positions using center-first approach'
            );
    ...
    useEffect(() => {
        ...
        console.log(
            `Recreated irrigation overlays: ${irrigationMarkersRef.current.length} markers, ${irrigationCirclesRef.current.length} circles`
        );
    }, [
        isMapLoaded,
        selectedIrrigationType,
    ...
    useEffect(() => {
        if (isMapLoaded && mapRef.current) {
            ...
            if (hasIrrigationData) {
                ...
                if (irrigationPositions.waterJets.length > 0) {
                    console.log(
                        'Recreating water jet overlays:',
                        irrigationPositions.waterJets.length
                    );
                ...
                console.log(
                    `Forced recreation completed: ${irrigationMarkersRef.current.length} markers, ${irrigationCirclesRef.current.length} circles`
                );
            }
        }
    }, [
                    ...
                    <div className="flex h-full">
                                ...
                                <div className="space-y-6 p-4">
                                        ...
                                        >
                                            ...
                                            <div className="border-t border-white pt-3">
                                                ...
                                                <div className="mt-1 text-xs text-yellow-400">
                                                    Debug: {finalPlantPoints.length} plants ×{' '}
                                                    {finalSelectedCrops.length > 0
                                                        ? (() => {
                                                              const crop = getCropByValue(
                                                                  finalSelectedCrops[0]
                                                              );
                                                              return crop
                                        ...
                                        >
                                            ...
                                            <div className="space-y-2 text-xs">
                                                ...
                                                <div className="flex justify-between text-gray-400">
                                                    ...
                                                    <span className="text-green-400">
                                                        {finalPerimeterMeters !== null
                                                            ? finalPerimeterMeters.toFixed(1)
                                                            : '--'}{' '}
                                                        {t('meters')}
                                                    </span>
                                                </div>
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            ...
                                            <div
                                                onClick={() =>
                                                    handleIrrigationTypeSelect('water_jet_tape')
                                                }
                                                className={`cursor-pointer rounded border border-white p-2 text-center transition-colors ${
                                            ...
                                            >
                                                ...
                                                {irrigationCounts.water_jet_tape > 0 && (
                                                    <div className="mt-1 text-xs text-orange-300">
                                                        {irrigationCounts.water_jet_tape}{' '}
                                                        {t('generated')}
                                                    </div>
                                                )}
                                            </div>
                                            ...
                                            <div
                                                onClick={() =>
                                                    handleIrrigationTypeSelect('drip_tape')
                                                }
                                                className={`cursor-pointer rounded border border-white p-2 text-center transition-colors ${
                            ...
                            <div className="border-t border-white p-4">
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        onClick={() => {
                                            console.log(
                                                'Resetting irrigation settings - clearing irrigation config but keeping field data'
                                            );
                        ...
                        <div className="relative flex-1">
                            ...
                            >
                                ...
                                />
                                <div className="absolute right-4 top-4 z-10 rounded-lg border border-white bg-black bg-opacity-80 p-3 text-xs">
