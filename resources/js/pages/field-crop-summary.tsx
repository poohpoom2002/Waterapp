...
export default function FieldCropSummary(props: FieldCropSummaryProps = {}) {
    ...
    return (
        <div className="flex h-screen flex-col overflow-hidden bg-gray-900 text-white print:bg-white print:text-black">
            ...
            {/* FANGGY005 EDIT: Navbar is now a direct child and will not scroll */}
            <Navbar />

            {/* FANGGY005 EDIT: สร้าง wrapper ใหม่สำหรับส่วนที่ scroll ได้ทั้งหมด */}
            <div className="flex-1 overflow-y-auto"> 
                ...
                {/* FANGGY005 EDIT: ย้าย print:print-layout มาที่นี่ และเอา flex-1, overflow-y-auto ออก */}
