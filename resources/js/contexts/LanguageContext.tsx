...
const translations = {
    en: {
        ...
        efficient_irrigation: 'Efficient irrigation',
        ...
        // Home Garden Pages
        home_garden_system: 'Home Garden Water System',
        ...
        zone_tab: 'Zones',
        sprinkler_tab: 'Sprinklers',
        pipe_tab: 'Pipes',
        validation_error_title: 'Cannot view summary',
        validation_error_message: 'Please fix the following issues first:',
        ok: 'OK',
        summary_title: 'Water System Design Summary',
        back_to_planner: 'Back to Planner',
        save_image: 'Save Image (.png)',
        print_image: 'Print Image',
        calculate_equipment: 'Calculate Equipment',
        loading_data: 'Loading data...',
        no_design_data: 'No design data found',
        error_loading_data: 'Error loading data',
        date: 'Date',
        time: 'Time',
        zone_area: 'Zone Area',
        sprinkler_count: 'Sprinkler Count',
    ...
    th: {
        ...
        efficient_irrigation: 'ชลประทานที่มีประสิทธิภาพ',
        ...
        // Home Garden Pages
        home_garden_system: 'ระบบออกแบบระบบน้ำสำหรับสวนบ้าน',
        choose_design_method: 'เลือกวิธีการออกแบบ',
        google_map: 'Google Map',
        draw_yourself: 'วาดเอง',
        use_blueprint: 'ใช้รูปแบบแปลน',
        see_summary: 'ดูสรุปผล',
        change_method: 'เปลี่ยนวิธี',
        delete_all: 'ลบทั้งหมด',
        zone_tab: 'กำหนดโซน',
        sprinkler_tab: 'วางหัวฉีด',
        pipe_tab: 'ระบบท่อ',
        validation_error_title: 'ไม่สามารถดูสรุปผลได้',
        validation_error_message: 'กรุณาแก้ไขปัญหาต่อไปนี้ก่อน:',
        ok: 'ตกลง',
        summary_title: 'สรุปผลการออกแบบระบบน้ำ',
        back_to_planner: 'กลับไปหน้าออกแบบ',
        save_image: 'บันทึกรูปภาพ (.png)',
        print_image: 'พิมพ์รูปภาพ',
        calculate_equipment: 'คำนวณอุปกรณ์',
        loading_data: 'กำลังโหลดข้อมูล...',
        no_design_data: 'ไม่พบข้อมูลการออกแบบ',
        error_loading_data: 'เกิดข้อผิดพลาดในการโหลดข้อมูล',
        date: 'วันที่',
        time: 'เวลา',
        zone_area: 'พื้นที่โซน',
        sprinkler_count: 'จำนวนหัวฉีด',
        sprinkler_type: 'ประเภทหัวฉีด',
        radius: 'รัศมี',
        pipe_system: 'ระบบท่อ',
        ...
        // Greenhouse translations
        greenhouse_title: 'โรงเรือน',
        greenhouse_subtitle: 'เลือกพืชสำหรับโรงเรือนของคุณ',
        greenhouse_crop_selection: 'เลือกพืชในโรงเรือน',
        greenhouse_crop_description: 'เลือกพืชที่คุณต้องการปลูกในโรงเรือน สามารถเลือกได้หลายชนิด',
        greenhouse_planning_method: 'เลือกวิธีการวางแผนพื้นที่',
        greenhouse_planning_description: 'เลือกวิธีการที่คุณต้องการใช้ในการกำหนดพื้นที่โรงเรือน',
        greenhouse_draw_method: 'วาดพื้นที่เอง',
        greenhouse_draw_description: 'ใช้เครื่องมือวาดในระบบเพื่อกำหนดรูปร่างและขนาดโรงเรือน',
        greenhouse_import_method: 'นำเข้าไฟล์',
        greenhouse_import_description: 'นำเข้าแบบแปลนหรือการออกแบบโรงเรือนที่มีอยู่',
        greenhouse_draw_recommended: 'หากคุณเป็นผู้เริ่มต้นหรือไม่มีไฟล์แบบแปลน แนะนำให้เลือก "วาดพื้นที่เอง" เพราะจะง่ายกว่าและมีเทมเพลตโรงเรือนมาตรฐานให้เลือกใช้',
        greenhouse_template_selection: 'เลือกเทมเพลตโรงเรือนหรือวาดแบบอิสระ',
        greenhouse_size_shape: 'กำหนดขนาดและรูปร่างโรงเรือน',
        greenhouse_plots_walkways: 'เพิ่มแปลงปลูกและพื้นที่เดิน',
        greenhouse_confirm_next: 'ยืนยันและไปขั้นตอนถัดไป',
        greenhouse_import_steps: 'อัปโหลดไฟล์แบบแปลน (DWG, DXF, PDF, หรือรูปภาพ)',
        greenhouse_import_adjust: 'ปรับขนาดและตำแหน่งให้ถูกต้อง',
        greenhouse_import_overlay: 'วาดทับพื้นที่โรงเรือนและแปลงปลูก',
        greenhouse_import_confirm: 'ยืนยันและไปขั้นตอนถัดไป',
        greenhouse_design_title: 'ออกแบบพื้นที่โรงเรือน พร้อมระบบวัดระยะ',
        greenhouse_design_description: 'วาดโครงสร้างโรงเรือนและแปลงปลูกของคุณ - พื้นที่ 2400x1600 pixels (1 grid = 1 เมตร)',
        greenhouse_structure: 'โรงเรือน',
        greenhouse_plot: 'แปลงปลูก',
        greenhouse_walkway: 'ทางเดิน',
        greenhouse_water_source: 'แหล่งน้ำ',
        greenhouse_measurement: 'การวัด',
        greenhouse_draw_structure: 'วาดโครงสร้างโรงเรือน',
        greenhouse_draw_structure_desc: 'คลิกเพื่อเริ่มวาดโครงสร้างโรงเรือน',
        greenhouse_structure_green: 'โรงเรือนจะแสดงเป็นพื้นที่สีเขียว',
        greenhouse_draw_walkway: 'วาดทางเดินในโรงเรือน',
        greenhouse_draw_walkway_desc: 'คลิกเพื่อเริ่มวาดทางเดิน',
        greenhouse_walkway_gray: 'ทางเดินจะแสดงเป็นพื้นที่สีเทา',
        greenhouse_irrigation_design: 'ออกแบบระบบน้ำในโรงเรือน (ขนาดใหญ่)',
        greenhouse_irrigation_method: 'วิธีการให้น้ำที่เลือก',
        greenhouse_irrigation_design_desc: 'ออกแบบระบบการให้น้ำแบบ:',
        greenhouse_irrigation_design_area: 'พื้นที่ 2400x1600 pixels',
        greenhouse_summary_title: 'สรุปการวางแผนโรงเรือน',
        greenhouse_summary_description: 'ภาพรวมการออกแบบโรงเรือนและระบบการให้น้ำ',
        greenhouse_summary_print_title: 'สรุปการวางแผนโรงเรือน',
        greenhouse_summary_print_description: 'ภาพรวมการออกแบบโรงเรือนและระบบการให้น้ำ',
        greenhouse_area_sqm: 'พื้นที่โรงเรือน (ตร.ม.)',
        greenhouse_plot_area_sqm: 'พื้นที่แปลงปลูก (ตร.ม.)',
        greenhouse_plot_count: 'จำนวนแปลงปลูก',
        greenhouse_structure_count: 'จำนวนโครงสร้าง',
        greenhouse_blueprint_title: 'แบบแปลนโรงเรือนพร้อมระบบการให้น้ำ',
        greenhouse_blueprint_description: 'รายละเอียดโครงสร้างโรงเรือนและการติดตั้งอุปกรณ์',
        greenhouse_blueprint_main: 'แบบแปลนโรงเรือน (พร้อมระบบน้ำ)',
        greenhouse_blueprint_center: 'แบบแปลนโรงเรือนพร้อมระบบการให้น้ำและอุปกรณ์ทั้งหมด (อยู่ตรงกลาง)',
        greenhouse_blueprint_explanation: 'แบบแปลนนี้แสดงตำแหน่งของโครงสร้างโรงเรือนและระบบการให้น้ำทั้งหมด',
        greenhouse_blueprint_legend: 'สีน้ำตาล: โครงสร้างโรงเรือน',
        greenhouse_structure_detail: 'โครงสร้างโรงเรือน',
        greenhouse_document_generated: 'เอกสารนี้สร้างโดยระบบวางแผนโรงเรือนอัตโนมัติ - หน้า',
        greenhouse_document_page: 'หน้า',
        greenhouse_irrigation_selection: 'เลือกระบบการให้น้ำ',
        greenhouse_irrigation_description: 'โปรดเลือกวิธีการให้น้ำที่เหมาะสมกับความต้องการของคุณ',
        greenhouse_mini_sprinkler: 'มินิสปริงเกลอร์',
        greenhouse_mini_sprinkler_desc: 'ให้น้ำเป็นวงแคบลงมา เหมาะสำหรับแปลงผักหรือไม้พุ่ม',
        greenhouse_drip: 'น้ำหยด',
        greenhouse_drip_desc: 'ประหยดน้ำสูงสุด โดยให้น้ำโดยตรงที่โคนต้นพืช',
        greenhouse_mixed: 'แบบผสม',
        greenhouse_mixed_desc: 'ผสมผสานระบบต่างๆ เพื่อให้เหมาะกับพืชหลากหลายชนิด',
        greenhouse_mixed_development: 'กำลังพัฒนา',
        greenhouse_selected_data: 'ข้อมูลที่เลือกไว้',
        greenhouse_selected_crops: 'พืชที่เลือก',
        greenhouse_greenhouse_plans: 'มีแบบโรงเรือนที่วาดไว้แล้ว',
        greenhouse_back_to_planning: 'กลับไปออกแบบพื้นที่',
        greenhouse_proceed_to_irrigation: 'ไปออกแบบระบบน้ำ',
        greenhouse_no_greenhouse_data: 'ไม่พบข้อมูลโรงเรือน',
        greenhouse_no_data_message: 'ดูเหมือนว่าคุณยังไม่ได้ทำโครงการวางแผนโรงเรือนให้เสร็จ หรือข้อมูลถูกล้างแล้ว',
        greenhouse_to_view_summary: 'เพื่อดูสรุป กรุณา:',
        greenhouse_go_to_planning: 'ไปที่หน้าวางแผนโรงเรือน',
        greenhouse_complete_design: 'ทำกระบวนการออกแบบโรงเรือนให้เสร็จ',
        greenhouse_click_summary: 'คลิกปุ่ม "ดูสรุป" ที่ปรากฏ',
        greenhouse_start_new: 'เริ่มต้นใหม่',
    },
};
