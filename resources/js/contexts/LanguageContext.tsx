...
const translations = {
    en: {
        ...
        'คลิกปุ่มด้านบนเพื่อบันทึกและไปยังหน้าผลลัพธ์': 'Click the button above to save and go to the results page',
        'ยังไม่พร้อมบันทึก': 'Not ready to save',
        'ต้องมีพื้นที่หลักและปั๊มน้ำก่อนบันทึกได้': 'You must have a main area and pump before saving',
        ...
        'โครงการบันทึกสำเร็จ! กำลังกลับไปหน้าหลัก': 'Project saved successfully! Returning to home page',
        ...
        'เปิดข้อมูลในหน้าต่างใหม่ กรุณาคัดลอกด้วยตนเอง': 'Data opened in new window, please copy manually',
        'สร้าง...': 'Creating...',
        ...
        'คุณต้องการลบท่อย่อยนี้หรือไม่ ต้นไม้ที่เชื่อมต่อจะถูกลบด้วย': 'Do you want to delete this branch pipe? Connected plants will also be deleted',
        ...
        'กรุณาสร้างพื้นที่หลัก ปั๊ม และสร้างท่อพร้อมต้นไม้ก่อนเข้าสู่โหมดแก้ไข': 'Please create main area, pump, and pipes with plants before entering edit mode',
        'กรุณาวางปั๊มและสร้างพื้นที่หลักก่อนบันทึก': 'Please place pump and create main area before saving',
        ...
        '📋 ขั้นตอนการทำงาน': '📋 Work Steps',
        '✨ โหมดแก้ไขขั้นสูง': '✨ Advanced Edit Mode',
        'หลังจากบันทึกต้นไม้แล้ว คุณสามารถสร้างท่อย่อยเชื่อมต่อไปยังท่อเมนรองหรือท่อย่อยอื่นได้': 'After saving plants, you can create branch pipes connected to sub-main or other branch pipes',
        ...
        'การหมุนจะถูกรีเซ็ตอัตโนมัติเมื่อสร้างภาพ': 'Rotation is automatically reset when creating image',
        'ปรับขนาดไอคอนก่อนสร้างภาพเพื่อผลลัพธ์ที่ดี': 'Adjust icon size before creating image for better results',
        'ใช้ Screenshot หากการสร้างภาพอัตโนมัติไม่สำเร็จ': 'Use Screenshot if automatic image creation fails',
        ...
        'ใช้ขนาดไอคอนปานกลาง (1.0x) สำหรับผลลัพธ์ดีที่สุด': 'Use medium icon size (1.0x) for best results',
    ...
    th: {
        ...
        'คลิกปุ่มด้านบนเพื่อบันทึกและไปยังหน้าผลลัพธ์': 'คลิกปุ่มด้านบนเพื่อบันทึกและไปยังหน้าผลลัพธ์',
        ...
        'เปิดข้อมูลในหน้าต่างใหม่ กรุณาคัดลอกด้วยตนเอง': 'เปิดข้อมูลในหน้าต่างใหม่ กรุณาคัดลอกด้วยตนเอง',
        'สร้าง...': 'สร้าง...',
        ...
        'คุณต้องการลบท่อย่อยนี้หรือไม่ ต้นไม้ที่เชื่อมต่อจะถูกลบด้วย': 'คุณต้องการลบท่อย่อยนี้หรือไม่ ต้นไม้ที่เชื่อมต่อจะถูกลบด้วย',
        'พืชทั่วไป': 'พืชทั่วไป',
        ...
        'กรุณาสร้างพื้นที่หลัก ปั๊ม และสร้างท่อพร้อมต้นไม้ก่อนเข้าสู่โหมดแก้ไข': 'กรุณาสร้างพื้นที่หลัก ปั๊ม และสร้างท่อพร้อมต้นไม้ก่อนเข้าสู่โหมดแก้ไข',
        ...
        '📋 ขั้นตอนการทำงาน': '📋 ขั้นตอนการทำงาน',
        '✨ โหมดแก้ไขขั้นสูง': '✨ โหมดแก้ไขขั้นสูง',
        'หลังจากบันทึกต้นไม้แล้ว คุณสามารถสร้างท่อย่อยเชื่อมต่อไปยังท่อเมนรองหรือท่อย่อยอื่นได้': 'หลังจากบันทึกต้นไม้แล้ว คุณสามารถสร้างท่อย่อยเชื่อมต่อไปยังท่อเมนรองหรือท่อย่อยอื่นได้',
        ...
        'ล็อกการซูมและลาก เพื่อป้องกันการเปลี่ยนแปลง': 'ล็อกการซูมและลาก เพื่อป้องกันการเปลี่ยนแปลง',
        ...
        'ใช้ Screenshot หากการสร้างภาพอัตโนมัติไม่สำเร็จ': 'ใช้ Screenshot หากการสร้างภาพอัตโนมัติไม่สำเร็จ',
        ...
        'ใช้ขนาดไอคอนปานกลาง (1.0x) สำหรับผลลัพธ์ดีที่สุด': 'ใช้ขนาดไอคอนปานกลาง (1.0x) สำหรับผลลัพธ์ดีที่สุด',
