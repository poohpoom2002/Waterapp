export const horticultureTranslations = {
    en: {
        ...
        การลบพื้นที่หลักจะลบทุกอย่างในแผนที่:
            'Deleting the main area will remove everything on the map',
        ...
        คำเตือน: 'Warning',
        การแก้ไขจะเปลี่ยนต้นไม้ทั้งหมดในพื้นที่หลัก:
            'Editing will change all plants in the main area',
        การแก้ไขจะเปลี่ยนต้นไม้ทั้งหมดในพื้นที่ปลูกนี้:
            'Editing will change all plants in this planting area',
        ...
        ท่อจะถูกวางทับไปบนแนวยาวของแถวหรือคอลัมน์ต้นไม้โดยตรง:
            'Pipe will be placed directly over the center of plant rows or columns',
        'ท่อจะถูกวางในช่องว่างระหว่างแถวหรือคอลัมน์ของต้นไม้ 2 แถวที่อยู่ติดกัน':
            'Pipe will be placed in the gap between two adjacent plant rows or columns',
    ...
    th: {
        ...
        'บันทึกร่างสำเร็จ! แปลงจะถูกเก็บในโฟลเดอร์ "ยังไม่เสร็จ"':
            'บันทึกร่างสำเร็จ! แปลงจะถูกเก็บในโฟลเดอร์ "ยังไม่เสร็จ"',
        'อัปเดตร่างสำเร็จ! แปลงได้รับการอัปเดตในโฟลเดอร์ "ยังไม่เสร็จ"':
            'อัปเดตร่างสำเร็จ! แปลงได้รับการอัปเดตในโฟลเดอร์ "ยังไม่เสร็จ"',
        'เกิดข้อผิดพลาดในการบันทึกร่าง กรุณาลองใหม่อีกครั้ง':
            'เกิดข้อผิดพลาดในการบันทึกร่าง กรุณาลองใหม่อีกครั้ง',
    },
};
